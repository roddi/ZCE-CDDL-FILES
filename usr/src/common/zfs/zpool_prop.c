...
#ifdef __DARWIN__
	zprop_register_hidden(ZPOOL_PROP_BOOTFS, "bootfs",
	    PROP_TYPE_STRING, PROP_DEFAULT, ZFS_TYPE_POOL, "BOOTFS");
	zprop_register_hidden(ZPOOL_PROP_CACHEFILE, "cachefile",
	    PROP_TYPE_STRING, PROP_DEFAULT, ZFS_TYPE_POOL, "CACHEFILE");
#else
...
#ifdef __DARWIN__
	zprop_register_hidden(ZPOOL_PROP_DEDUPRATIO, "dedupratio",
	    PROP_TYPE_NUMBER, PROP_READONLY, ZFS_TYPE_POOL, "DEDUP");
...
#ifdef __DARWIN__
	zprop_register_hidden(ZPOOL_PROP_DELEGATION, "delegation",
	    PROP_TYPE_NUMBER, PROP_DEFAULT, ZFS_TYPE_POOL, "DELEGATION");
	zprop_register_hidden(ZPOOL_PROP_AUTOREPLACE, "autoreplace",
	    PROP_TYPE_NUMBER, PROP_DEFAULT, ZFS_TYPE_POOL, "REPLACE");
#else
...
#ifdef __DARWIN__
	    ZIO_FAILURE_MODE_CONTINUE, PROP_DEFAULT, ZFS_TYPE_POOL,
	    "wait | continue", "FAILMODE", failuremode_table);
#else
