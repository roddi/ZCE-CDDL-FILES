...
zfs_prop_init(void)
{
...
#ifndef __DARWIN__
		/* no mixed case mode under Darwin */
	...
	zprop_register_index(ZFS_PROP_CHECKSUM, "checksum",
	    ...
	    ZFS_TYPE_VOLUME,
#ifdef __DARWIN__
	    "on | fletcher2 | fletcher4 | sha256", "CHECKSUM",
#else
...
#ifdef __DARWIN__
	zprop_register_hidden(ZFS_PROP_DEDUP, "dedup", PROP_TYPE_NUMBER,
	    PROP_INHERIT, ZFS_TYPE_FILESYSTEM | ZFS_TYPE_VOLUME, "DEDUP");
#else
...
#ifdef __DARWIN__
	    "on | off | lzjb | gzip-[1-6] | zle", "COMPRESS",
#else
...
#ifdef __DARWIN__
	zprop_register_hidden(ZFS_PROP_ACLINHERIT, "aclinherit", PROP_TYPE_NUMBER,
	    PROP_INHERIT, ZFS_TYPE_FILESYSTEM, "ACLINHERIT");
#else
	...
	zprop_register_index(ZFS_PROP_READONLY, "readonly", 0, PROP_INHERIT,
	    ...
	    boolean_table);
#ifdef __DARWIN__
	zprop_register_hidden(ZFS_PROP_ZONED, "zoned", PROP_TYPE_NUMBER,
	    PROP_INHERIT, ZFS_TYPE_FILESYSTEM, "ZONED");
	zprop_register_hidden(ZFS_PROP_XATTR, "xattr", PROP_TYPE_NUMBER,
	    PROP_ONETIME, ZFS_TYPE_FILESYSTEM | ZFS_TYPE_SNAPSHOT, "XATTR");
	zprop_register_hidden(ZFS_PROP_VSCAN, "vscan", PROP_TYPE_NUMBER,
	    PROP_INHERIT, ZFS_TYPE_FILESYSTEM, "VSCAN");
	zprop_register_hidden(ZFS_PROP_NBMAND, "nbmand", PROP_TYPE_NUMBER,
...
#ifdef __DARWIN__
	    "none | formC | formD", "NORMALIZATION",
#else
	...
	zprop_register_string(ZFS_PROP_MOUNTPOINT, "mountpoint", "/",
	    ...
	    "MOUNTPOINT");
#ifdef __DARWIN__
	zprop_register_hidden(ZFS_PROP_SHARENFS, "sharenfs", PROP_TYPE_STRING,
...
#ifdef __DARWIN__
	zprop_register_hidden(ZFS_PROP_SHARESMB, "sharesmb", PROP_TYPE_STRING,
	    PROP_INHERIT, ZFS_TYPE_FILESYSTEM, "SHARESMB");
	zprop_register_hidden(ZFS_PROP_MLSLABEL, "mlslabel", PROP_TYPE_STRING,
	    PROP_INHERIT, ZFS_TYPE_DATASET, "MLSLABEL");
#else
...
#ifdef __DARWIN__
	zprop_register_hidden(ZFS_PROP_VOLBLOCKSIZE, "volblocksize",
	    PROP_TYPE_NUMBER, PROP_INHERIT, ZFS_TYPE_VOLUME, "VOLBLOCK");
#else
	...
	zprop_register_number(ZFS_PROP_RESERVATION, "reservation", 0,
	    ...
	    "<size> | none", "RESERV");
#ifdef __DARWIN__
	zprop_register_hidden(ZFS_PROP_VOLSIZE, "volsize",
	    PROP_TYPE_NUMBER, PROP_INHERIT, ZFS_TYPE_VOLUME, "VOLSIZE");
#else
