...
#ifdef __DARWIN__
	ZFSX_NOTIFY_USER_SCAN(spa_name(spa), spa_guid(spa),
	    (*funcp == POOL_SCAN_RESILVER), ZKEV_NOTIFY_SCAN_STARTED, 0);
#endif /* __DARWIN__ */
}
...
dsl_scan_done(dsl_scan_t *scn, boolean_t complete, dmu_tx_t *tx)
{
	...
	ZFSX_NOTIFY_USER_SCAN(spa_name(spa), spa_guid(spa),
	    (scn->scn_phys.scn_func == POOL_SCAN_RESILVER),
	    complete ? ZKEV_NOTIFY_SCAN_FINISHED : ZKEV_NOTIFY_SCAN_CANCELED,
