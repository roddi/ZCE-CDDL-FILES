...
#ifdef __DARWIN__
/*
 * Relocate the /dev/zfsx ioctl numbers here, from zfs.h,
 * since Darwin's ZFS_IOC base needs to know the size of zfs_cmd_t
 */

#include <sys/ioccom.h>

#define	ZFS_IOC_CMD(x)	((x) & 0x000000ff)

#define	ZFS_IOC		_IOC(IOC_INOUT,	'Z', 0, sizeof (zfs_cmd_t))
...
#ifdef __DARWIN__
	ZFS_IOC_RETAIN_PROXY,
	ZFS_IOC_RELEASE_PROXY
#endif
} zfs_ioc_t;
#endif /* __DARWIN__ */
