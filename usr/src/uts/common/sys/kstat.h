...
#define	KSTAT_IOC_CHAIN_ID_CMD	0x01
#define	KSTAT_IOC_READ_CMD	0x02
#define	KSTAT_IOC_WRITE_CMD	0x03

#define	KSTAT_IOC_CHAIN_ID	_IOC(IOC_OUT,	'K', KSTAT_IOC_CHAIN_ID_CMD, sizeof (kstat_t))
#define	KSTAT_IOC_READ		_IOC(IOC_INOUT,	'K', KSTAT_IOC_READ_CMD, sizeof (kstat_t))
#define	KSTAT_IOC_WRITE		_IOC(IOC_INOUT,	'K', KSTAT_IOC_WRITE_CMD, sizeof (kstat_t))

#define	KSTAT_IOC_CMD(x)	((x) & 0x000000ff)
...
typedef struct kstat {
	...
	int		ks_ioc_error;	/* holds ioctl error value */
